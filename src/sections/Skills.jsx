    ...
    return (
        <section className="bg-[#ececf0]" ref={refProp}>
            <div className="skill-section px-4 xxl:px-0 py-10 xl:py-20 max-w-[1440px] m-auto text-center" id="skill-section">
                <h2 className="text-[26px] md:text-[32px] lg:text-[40px] font-medium mb-3">Technical Skills</h2>
                <p className="text-gray-600 max-w-2xl m-auto mb-5 lg:mb-12">A comprehensive toolkit for building robust mobile applications</p>
                <div className="flex flex-wrap md:flex-nowrap gap-3 lg:gap-5 justify-center max-w-7xl m-auto">
                    <div className="w-full md:w-max">
                        <div className="bg-white border border-[#bdbdbd] mb-5 p-5 flex gap-4 md:gap-6 flex-col items-center rounded-lg md:min-h-[200px] lg:min-h-[160px]">
                            <p className="text-lg font-medium">Core Technologies</p>
                            <div className="flex gap-4 flex-wrap">
                                ...
                                <div className="bg-neutral-200 px-2 py-1 rounded-xl flex gap-2 items-center">
                                    ...
                                    <span className="relative">
                                        ...
                                        <span className="absolute hidden peer-hover:block peer-focus:block bg-black text-white sm:whitespace-nowrap w-[150px] sm:w-max left-0 right-0 p-2 text-xs rounded-md mt-2">Custom Themes, Blocks, Post Types</span>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div className="bg-white border border-[#bdbdbd] p-5 flex gap-4 md:gap-6 flex-col items-center rounded-lg md:min-h-[200px] lg:min-h-[160px]">
                            <p className="text-lg font-medium">State Management & Data Handling</p>
                            <div className="flex gap-4 flex-wrap">
                                ...
                                <div className="bg-neutral-200 px-2 py-1 rounded-xl flex gap-2 items-center">
                                    ...
                                    <button className="relative">
                                        <AiOutlineInfoCircle className="peer cursor-pointer outline-0" tabIndex={0} />
                                        <span className="absolute right-0 hidden peer-hover:block peer-focus:block bg-black text-white whitespace-nowrap p-2 mt-2 text-xs rounded-md">Fetch / Axios</span>
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="w-full md:w-max">
                        <div className="bg-white border border-[#bdbdbd] mb-5 p-5 flex gap-4 md:gap-6 flex-col items-center rounded-lg md:min-h-[200px] lg:min-h-[160px]">
                            <p className="text-lg font-medium">UI / Styling</p>
                            <div className="flex gap-4 flex-wrap">
                        ...
                        <div className="bg-white border border-[#bdbdbd] p-5 flex gap-4 md:gap-6 flex-col items-center rounded-lg md:min-h-[200px] lg:min-h-[160px]">
                            <p className="text-lg font-medium">Tools & Workflow</p>
                            <div className="flex gap-4 flex-wrap">
