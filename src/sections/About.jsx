...
const About = ({ refProp }) => {
    return (
        <>
            <section className="about-section px-4 xxl:px-0 py-10 xl:py-20 max-w-[1440px] m-auto text-center" id="about-section" ref={refProp}>
                <h2 className="text-[26px] md:text-[32px] lg:text-[40px] font-medium mb-3">About Me</h2>
                <p className="text-gray-600 max-w-2xl m-auto mb-5 lg:mb-12">Frontend Developer with 6 years of overall experience in developing responsive web layouts using
                ...
                <div className="about-box-section-wrap flex flex-wrap md:flex-nowrap gap-3 lg:gap-5">
                    <div className="about-box-section border border-[#bdbdbd] w-full p-3 lg:p-6 flex gap-3 lg:gap-6 flex-col items-center rounded-lg hover:shadow-[7px_7px_10px_-6px_#bdbdbd,3px_3px_0px_-4px_#bdbdbd] transition-all duration-300 ease-in-out">
                        ...
                        <p className="text-lg font-medium">Code Quality</p>
                        <p className="text-md text-gray-600">Writing maintainable and scalable code following best practices</p>
                    </div>
                    <div className="about-box-section border border-[#bdbdbd] w-full p-3 lg:p-6 flex gap-3 lg:gap-6 flex-col items-center rounded-lg hover:shadow-[7px_7px_10px_-6px_#bdbdbd,3px_3px_0px_-4px_#bdbdbd] transition-all duration-300 ease-in-out">
                        <div className="bg-stone-300 rounded-full w-10 h-10 flex items-center justify-center">
                            <AiOutlineMobile className="text-[20px]" />
                        </div>
                        <p className="text-lg font-medium">Responsive Layouts</p>
                        <p className="text-md text-gray-600">Ensuring seamless experiences across desktop, tablet, and mobile devices</p>
                    </div>
                    <div className="about-box-section border border-[#bdbdbd] w-full p-3 lg:p-6 flex gap-3 lg:gap-6 flex-col items-center rounded-lg hover:shadow-[7px_7px_10px_-6px_#bdbdbd,3px_3px_0px_-4px_#bdbdbd] transition-all duration-500 ease-in-out">
                        ...
                        <p className="text-lg font-medium">Optimized Performance</p>
                        <p className="text-md text-gray-600">Improving load times and runtime performance using modern techniques</p>
                    </div>
                    <div className="about-box-section border border-[#bdbdbd] w-full p-3 lg:p-6 flex gap-3 lg:gap-6 flex-col items-center rounded-lg hover:shadow-[7px_7px_10px_-6px_#bdbdbd,3px_3px_0px_-4px_#bdbdbd] transition-all duration-500 ease-in-out">
                        <div className="bg-stone-300 rounded-full w-10 h-10 flex items-center justify-center">
                            <AiOutlineTeam className="text-[25px]" />
                        </div>
                        <p className="text-lg font-medium">Collaboration</p>
                        <p className="text-md text-gray-600">Working closely with designers and backend teams to deliver quality products</p>
                    </div>
                </div>
            </section>
        </>
