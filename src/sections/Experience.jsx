        ...
        <>
            <section className="bg-[#ececf0]" ref={refProp}>
                <div className="experience-section px-4 xxl:px-0 py-10 xl:py-20 max-w-[1440px] m-auto text-center" id="experience-section">
                    <h2 className="text-[26px] md:text-[32px] lg:text-[40px] font-medium mb-3">Experience</h2>
                    <p className="text-gray-600 max-w-2xl m-auto mb-5 lg:mb-12">6 years of professional growth and impactful contributions</p>
                    <div className="exp-section-wrapper max-w-3xl m-auto">
                        <div className="exp-section mb-5 bg-white border border-[#bdbdbd] p-4 md:p-6 rounded-lg hover:shadow-[7px_7px_10px_-6px_#bdbdbd,3px_3px_0px_-4px_#bdbdbd] transition-all duration-300 ease-in-out">
                            <div className="flex gap-3">
                                ...
                                <div className="flex gap-2 flex-col sm:flex-row justify-between w-full mb-4">
                                    <div className="text-left">
                                        <p className="text-[18px] font-medium">Sr. Software Developer</p>
                                        <p className="text-[#717182]">Elito Innovations Pvt Ltd</p>
                                    </div>
                                    <div className="flex gap-2 text-[#717182]">
                                        <AiOutlineCalendar className="text-[22px]" />Feb 2023 - Present
                                    </div>
                                </div>
                            </div>

                            <div className="text-left ml-7 md:ml-17 text-[#717182]">
                        ...
                        <div className="exp-section mb-5 bg-white border border-[#bdbdbd] p-4 md:p-6 rounded-lg hover:shadow-[7px_7px_10px_-6px_#bdbdbd,3px_3px_0px_-4px_#bdbdbd] transition-all duration-300 ease-in-out">
                            <div className="flex gap-3">
                                ...
                                <div className="flex gap-2 flex-col sm:flex-row justify-between w-full mb-4">
                                    <div className="text-left">
                                        <p className="text-[18px] font-medium">Junior Software Engineer</p>
                                        <p className="text-[#717182]">Madon Limited</p>
                                    </div>
                                    <div className="flex gap-2 text-[#717182]">
                            ...
                            <h4 className="text-left ml-3 md:ml-12 mb-3 font-medium">WordPress Experience</h4>
                            <div className="text-left ml-7 md:ml-17 text-[#717182] mb-3">
                                <ul className="list-disc flex gap-3 flex-col">
                            ...
                            <h4 className="text-left ml-3 md:ml-12 mb-3 font-medium">React Experience (1 Year)</h4>
                            <div className="text-left ml-7 md:ml-17 text-[#717182]">
                                <ul className="list-disc flex gap-3 flex-col">
                        ...
                        <div className="exp-section bg-white border border-[#bdbdbd] p-4 md:p-6 rounded-lg hover:shadow-[7px_7px_10px_-6px_#bdbdbd,3px_3px_0px_-4px_#bdbdbd] transition-all duration-300 ease-in-out">
                            <div className="flex gap-3">
                                <div className="bg-stone-300 rounded-full p-2 w-10 h-10 flex items-center justify-center">
                                    <FiBriefcase className="text-[24px]" />
                                </div>
                                <div className="flex gap-2 flex-col sm:flex-row justify-between w-full mb-4">
                                    <div className="text-left">
                                        <p className="text-[18px] font-medium">Intern</p>
                                        <p className="text-[#717182]">Madon Limited</p>
                                    </div>
                                    <div className="flex gap-2 text-[#717182]">
